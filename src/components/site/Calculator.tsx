...
const Calculator = () => {
  ...
  return (
    <section id="calc" className="relative scroll-mt-20 overflow-hidden border-y border-border bg-card/40 py-24 sm:py-32">
        ...
        <div className="mt-14 grid gap-px border border-border bg-border lg:grid-cols-2">
          ...
          <div className="relative bg-primary p-8 text-primary-foreground sm:p-10">
            ...
            <div className="relative">
              ...
              <div className="mt-10 space-y-px bg-primary-foreground/15">
              ...
              <Button
                ...
                variant="secondary"
                size="lg"
                className="mt-8 h-14 w-full font-display text-base uppercase tracking-[0.12em]"
              >
                Зафиксировать цену
              </Button>
            </div>
